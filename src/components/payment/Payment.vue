...
export default {
  ...
  setup() {
    ...
    const initializePaymentWidget = async () => {
      ...
      const customerKey = generateRandomString(); // 사용자 키
      ...
      button.addEventListener("click", async () => {
        await widgets.requestPayment({
          ...
          successUrl: `http://localhost:5173/payment/success`, // 결제 성공 페이지 URL
          failUrl: `http://localhost:5173/payment/fail`, // 결제 실패 페이지 URL
